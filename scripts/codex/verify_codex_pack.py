...
checks={
    ...
    'docs/codex/SKILL_DIGEST.md':['Skills methode globales','Skills metier Codex locales','Skills runtime applicatives','aurora-lot-runner','aurora-domain-skill-factory','aurora-ui-visual-qa','docs/codex/project-skills'],
    ...
    'docs/codex/tasks/_TEMPLATE/loop_contract.json':['schema_version','status_decision','lot_design_evidence_gate','backlog_mutation_gate','global_impact_gate','propagation_gate','lot_completion_gate','ui_validation_gate','e2e_user_tests','conversation_transition','resume_protocol'],
