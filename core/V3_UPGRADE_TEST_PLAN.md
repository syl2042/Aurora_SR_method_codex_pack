...
- `SR_PACK_VERSION.json` indique `3.2.1` ;
...
Objectif verifiable : mettre a jour uniquement la SR Method vers la version 3.2.1 depuis le repo officiel, verifier l'installation, puis stopper avant tout developpement applicatif.
