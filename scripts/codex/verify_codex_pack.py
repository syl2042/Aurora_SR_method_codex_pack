...
checks={
    ...
    'docs/codex/tasks/_TEMPLATE/gate_report.md':['Tests E2E utilisateur a faire','Backlog Mutation Gate','Lot Design Evidence Gate','Global Impact Gate','Lot Dependency Reconciliation','Propagation Gate','Lot Completion Gate','Context Budget Gate','Self Evaluation Gate','Fact Gate','Knowledge Gate','Loop Contract'],
    'docs/codex/tasks/_TEMPLATE/loop_contract.json':['schema_version','status_decision','lot_design_evidence_gate','backlog_mutation_gate','global_impact_gate','propagation_gate','lot_completion_gate','e2e_user_tests','conversation_transition','resume_protocol'],
...
if source_mode:
    checks={
        ...
        'core/SR_HARNESS_METHOD.md':['SR_PASSES.yaml','Backlog Mutation Gate','Lot Design Evidence Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Pass Runtime Goal','Goal Length Gate','Lot Completion Gate','Propagation Gate'],
        'core/LOT_EXECUTION_METHOD.md':['Pass Planning Gate','Pass Runtime Goal','Goal Length Gate','Lot Design Evidence Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Propagation Gate','validate_pass_contract.py','build_pass_runtime_goal.py'],
        ...
        'prompts/05_upgrade_codex_environment.md':['https://github.com/syl2042/Aurora_SR_method_codex_pack','commit source','SR_PACK_SOURCE','upgrade_legacy_unknown','Lot Design Evidence Gate','effet secondaire implicite','sous-phase separee','Propagation Gate'],
        'scripts/codex/audit_sr_task_contracts.py':['LEGACY_LOT_COMPLETION_GATE_CUTOFF','legacy_compat'],
        'scripts/install_codex_pack.py':['default','docs/codex/SR_BOOTSTRAP.md','Lot Design Evidence Gate','Propagation Gate'],
