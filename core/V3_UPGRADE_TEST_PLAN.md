...
## Perimetre V3
SR 3.0.0 est la base de schema V3 ; le pack 3.2.0 distribue ces controles avec les corrections contexte, Fact Gate, CURRENT_STATE plein regime, Pydantic Output Contract pour les agents IA runtime, Backlog Mutation Gate, Global Impact Gate, SR Passes et la methode agents runtime agnostique. SR V3 ajoute notamment :
...
- `SR_PACK_VERSION.json` indique `3.2.0` ;
...
Objectif verifiable : mettre a jour uniquement la SR Method vers la version 3.2.0 depuis le repo officiel, verifier l'installation, puis stopper avant tout developpement applicatif.
