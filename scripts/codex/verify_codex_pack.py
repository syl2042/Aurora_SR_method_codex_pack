...
if source_mode:
    checks={
        ...
        'prompts/05_upgrade_codex_environment.md':['https://github.com/syl2042/Aurora_SR_method_codex_pack','commit source','SR_PACK_SOURCE','upgrade_legacy_unknown','Lot Design Evidence Gate','Propagation Gate'],
