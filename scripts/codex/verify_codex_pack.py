...
if source_mode:
    checks={
        ...
        'core/SR_HARNESS_METHOD.md':['SR_PASSES.yaml','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Pass Runtime Goal','Goal Length Gate','Lot Completion Gate','Propagation Gate'],
        'core/LOT_EXECUTION_METHOD.md':['Pass Planning Gate','Pass Runtime Goal','Goal Length Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Propagation Gate','validate_pass_contract.py','build_pass_runtime_goal.py'],
