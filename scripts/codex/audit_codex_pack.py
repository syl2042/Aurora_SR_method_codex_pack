...
REQUIRED = {
    ...
    "docs/codex/tasks/_TEMPLATE/gate_report.md": ["Gate Report", "Tests E2E utilisateur a faire", "Backlog Mutation Gate", "Lot Design Evidence Gate", "Global Impact Gate", "Lot Dependency Reconciliation", "Propagation Gate", "Pass Runtime Goal", "Goal Length Gate", "Lot Completion Gate", "Context Budget Gate", "Self Evaluation Gate", "Fact Gate", "Knowledge Gate", "Loop Contract"],
    ...
    "docs/codex/prompts/06_verify_sr_installation.md": ["sr_post_install_check.py", "SR Contract 3.0.0", "audit_sr_task_contracts.py", "Propagation Gate"],
...
SOURCE_REQUIRED = {
    ...
    "core/SR_HARNESS_METHOD.md": ["SR Development Method", "SR_INBOX.yaml", "SR_LOTS.yaml", "SR_PASSES.yaml", "Backlog Mutation Gate", "Lot Design Evidence Gate", "Global Impact Gate", "Lot Dependency Reconciliation", "Pass Planning Gate", "Pass Runtime Goal", "Goal Length Gate", "Lot Completion Gate", "Propagation Gate", "build_pass_runtime_goal.py"],
    "core/LOT_EXECUTION_METHOD.md": ["Boucle lot", "Lot Design Evidence Gate", "Pass Planning Gate", "Pass Runtime Goal", "Goal Length Gate", "Backlog Mutation Gate", "Global Impact Gate", "Lot Completion Gate", "Propagation Gate", "loop_contract.json", "sr_contract.json", "build_pass_runtime_goal.py"],
    "core/SR_PACK_VERSION.json": ["3.5.2"],
    "core/V3_UPGRADE_TEST_PLAN.md": ["SR 3.0.0", "Prompt initial pour projet pilote"],
    "prompts/05_upgrade_codex_environment.md": ["SR_PACK_SOURCE", "commit source", "upgrade_legacy_unknown", "Lot Design Evidence Gate", "effet secondaire implicite", "sous-phase separee", "Propagation Gate"],
