...
3. Construir o grafo `depends_on`, `blocked_by`, `impacts`, `impacted_by`.
4. Propor passagens com ordem, rationale, preflight, validacoes humanas, migracoes/acoes externas, fontes compartilhadas, E2E agrupado e stop conditions.
5. Criar ou atualizar `SR_PASSES.yaml` somente apos validacao se o projeto impuser validacao estrita.
6. Validar com `python3 scripts/codex/validate_pass_contract.py --file docs/codex/SR_PASSES.yaml --lots-file docs/codex/SR_LOTS.yaml`.
