...
checks={
    ...
    'docs/codex/SR_HARNESS_METHOD.md':['SR Development Method','SR_INBOX.yaml','SR_LOTS.yaml','SR_PASSES.yaml','Evidence gate','Fact gate','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Execution multi-lots par defaut','Visibilite utilisateur obligatoire','Modes de connaissance codebase','Self evaluation gate','Loop Contract','SR Contract 3.0.0','validate_sr_contract.py','validate_lot_contract.py','validate_pass_contract.py'],
    'docs/codex/LOT_EXECUTION_METHOD.md':['Boucle lot','Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','Design gate minimal','Context budget gate','Self evaluation gate','tests E2E utilisateur','loop_contract.json','sr_contract.json','validate_lot_contract.py','validate_pass_contract.py'],
...
if source_mode:
    checks={
        ...
        'core/SR_HARNESS_METHOD.md':['SR_PASSES.yaml','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate'],
        'core/LOT_EXECUTION_METHOD.md':['Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','validate_pass_contract.py'],
