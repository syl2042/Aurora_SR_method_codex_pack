...
1. Leer `AGENTS.md` y `docs/codex/SR_BOOTSTRAP.md`; CURRENT_STATE para estado global o reanudacion ausente/contradictoria.
2. Ejecutar `python3 scripts/codex/find_next_session_prompt.py --root . --json`. Usar `selected`; si `ambiguous`, pedir la ruta y usar `--prompt`. No elegir `latest` silenciosamente.
