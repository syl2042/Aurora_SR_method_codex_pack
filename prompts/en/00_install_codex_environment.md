...
7. For a blank project, do not generate a goal immediately: recommend defining lots first, then `prompts/en/08_define_sr_passes_from_lots.md`, then generating a Pass Runtime Goal only for a `validated` or `in_progress` pass.
