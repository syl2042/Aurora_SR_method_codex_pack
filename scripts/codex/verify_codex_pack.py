...
checks={
    'AGENTS.md':['SR Bootstrap obligatoire','AI_AGENT_RUNTIME_METHOD','DOMAIN_EXPERTISE_BOOTSTRAP','Memoire SR','aurora-lot-runner','Evidence gate obligatoire','Fact Gate obligatoire','Tests E2E utilisateur','Context budget gate','Self Evaluation Gate','Loop Contract','find_next_session_prompt.py','SKILL_DIGEST.md','validate_lot_contract.py','Validation humaine stricte'],
    ...
    'docs/codex/SR_HARNESS_METHOD.md':['SR Development Method','SR_INBOX.yaml','SR_LOTS.yaml','Evidence gate','Fact gate','Execution multi-lots par defaut','Visibilite utilisateur obligatoire','Modes de connaissance codebase','Self evaluation gate','Loop Contract','SR Contract 3.0.0','validate_sr_contract.py','validate_lot_contract.py'],
    'docs/codex/LOT_EXECUTION_METHOD.md':['Boucle lot','Design gate minimal','Context budget gate','Self evaluation gate','tests E2E utilisateur','loop_contract.json','sr_contract.json','validate_lot_contract.py'],
    ...
    'docs/codex/tasks/_TEMPLATE/gate_report.md':['Tests E2E utilisateur a faire','Context Budget Gate','Self Evaluation Gate','Fact Gate','Knowledge Gate','Loop Contract'],
