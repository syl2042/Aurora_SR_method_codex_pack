...
7. Pour un projet vierge, ne pas generer de goal immediatement : recommander d'abord la definition des lots, puis `prompts/fr/08_define_sr_passes_from_lots.md`, puis la generation d'un Pass Runtime Goal uniquement pour une passe `validated` ou `in_progress`.
