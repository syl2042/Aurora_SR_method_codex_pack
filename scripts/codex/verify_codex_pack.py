...
checks={
    'AGENTS.md':['SR Bootstrap obligatoire','AI_AGENT_RUNTIME_METHOD','DOMAIN_EXPERTISE_BOOTSTRAP','Memoire SR','aurora-lot-runner','Evidence gate obligatoire','Fact Gate obligatoire','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Tests E2E utilisateur','Context budget gate','Self Evaluation Gate','Loop Contract','find_next_session_prompt.py','SKILL_DIGEST.md','validate_lot_contract.py','Validation humaine stricte'],
    'docs/codex/WORKFLOW_CODEX.md':['Bootstrap obligatoire','Agents IA runtime','Domaine metier'],
    'docs/codex/SR_METHOD.md':['Specification Runtime','SR Development Method','SR Agent Method','Validation humaine stricte','Regle de completude'],
    ...
    'docs/codex/SR_HARNESS_METHOD.md':['SR Development Method','SR_INBOX.yaml','SR_LOTS.yaml','SR_PASSES.yaml','Evidence gate','Fact gate','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Lot Completion Gate','Execution multi-lots par defaut','Visibilite utilisateur obligatoire','Modes de connaissance codebase','Self evaluation gate','Loop Contract','SR Contract 3.0.0','validate_sr_contract.py','validate_lot_contract.py','validate_pass_contract.py'],
    'docs/codex/LOT_EXECUTION_METHOD.md':['Boucle lot','Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Design gate minimal','Context budget gate','Self evaluation gate','tests E2E utilisateur','loop_contract.json','sr_contract.json','validate_lot_contract.py','validate_pass_contract.py'],
    ...
    'docs/codex/tasks/_TEMPLATE/gate_report.md':['Tests E2E utilisateur a faire','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Lot Completion Gate','Context Budget Gate','Self Evaluation Gate','Fact Gate','Knowledge Gate','Loop Contract'],
    'docs/codex/tasks/_TEMPLATE/loop_contract.json':['schema_version','status_decision','backlog_mutation_gate','global_impact_gate','lot_completion_gate','e2e_user_tests','conversation_transition','resume_protocol'],
    'docs/codex/tasks/_TEMPLATE/sr_contract.json':['schema_version','validated_requests','lot_completion_gate','backlog_mutation','global_impact','transition'],
    ...
    'scripts/codex/validate_loop_contract.py':['SR loop contract','lot_completion_gate'],
    'scripts/codex/validate_sr_contract.py':['SR 3.0.0','validated_requests','lot_completion_gate'],
    ...
    'docs/codex/prompts/60_review_diff_before_close.md':['SR Contract 3.0.0','validate_sr_contract.py','validated_requests','validate_lot_contract.py','Lot Completion Gate'],
}
if source_mode:
    checks={
        'core/SR_BOOTSTRAP.md':['Memoire de tache','Auto-reprise obligatoire','Validation humaine stricte','Lot Completion Gate'],
        'core/SR_METHOD.md':['Specification Runtime','SR Development Method','SR Agent Method','Regle de completude'],
        'core/SR_HARNESS_METHOD.md':['SR_PASSES.yaml','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Lot Completion Gate'],
        'core/LOT_EXECUTION_METHOD.md':['Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','validate_pass_contract.py'],
