...
checks={
    ...
    'docs/codex/PROJECT_PROFILE.yaml':['require_sr_bootstrap_on_resume','require_agent_runtime_contract','domain_expertise','knowledge:','context_budget:','lot_naming:','require_sr_contract','require_loop_contract','require_conversation_transition_decision','require_propagation_gate_for_reference_changes','digest:'],
    'docs/codex/SR_BOOTSTRAP.md':['compact/resume','Memoire de tache','Auto-reprise obligatoire','Reprise SR stricte','Validation humaine stricte','Propagation Gate'],
    ...
    'docs/codex/SR_HARNESS_METHOD.md':['SR Development Method','SR_INBOX.yaml','SR_LOTS.yaml','SR_PASSES.yaml','Evidence gate','Fact gate','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Lot Completion Gate','Propagation Gate','Execution multi-lots par defaut','Visibilite utilisateur obligatoire','Modes de connaissance codebase','Self evaluation gate','Loop Contract','SR Contract 3.0.0','validate_sr_contract.py','validate_lot_contract.py','validate_pass_contract.py'],
    'docs/codex/LOT_EXECUTION_METHOD.md':['Boucle lot','Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Propagation Gate','Design gate minimal','Context budget gate','Self evaluation gate','tests E2E utilisateur','loop_contract.json','sr_contract.json','validate_lot_contract.py','validate_pass_contract.py'],
    ...
    'docs/codex/tasks/_TEMPLATE/gate_report.md':['Tests E2E utilisateur a faire','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Propagation Gate','Lot Completion Gate','Context Budget Gate','Self Evaluation Gate','Fact Gate','Knowledge Gate','Loop Contract'],
    ...
    'docs/codex/prompts/60_review_diff_before_close.md':['SR Contract 3.0.0','validate_sr_contract.py','validated_requests','validate_lot_contract.py','Lot Completion Gate','Propagation Gate'],
}
if source_mode:
    checks={
        ...
        'core/SR_HARNESS_METHOD.md':['SR_PASSES.yaml','Backlog Mutation Gate','Global Impact Gate','Lot Dependency Reconciliation','Pass Planning Gate','Lot Completion Gate','Propagation Gate'],
        'core/LOT_EXECUTION_METHOD.md':['Pass Planning Gate','Backlog Mutation Gate','Global Impact Gate','Lot Completion Gate','Propagation Gate','validate_pass_contract.py'],
        ...
        'prompts/05_upgrade_codex_environment.md':['https://github.com/syl2042/Aurora_SR_method_codex_pack','commit source','SR_PACK_SOURCE','Propagation Gate'],
        'scripts/install_codex_pack.py':['default','docs/codex/SR_BOOTSTRAP.md','Propagation Gate'],
